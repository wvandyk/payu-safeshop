...
describe "PayuSafeshop" do
  ...
  it "should generate xml for the settle call" do
    @t.build_settle_transaction.should == "<?xml version=\"1.0\" ?>\r\n<Safe><Merchant><SafeKey>#{PayUSafeShop.get_config['primary-key']}</SafeKey></Merchant><Transactions><Settle><MerchantReference></MerchantReference><SafePayRefNr></SafePayRefNr><Amount>1250</Amount><BankRefNr></BankRefNr></Settle></Transactions></Safe>"
  end
